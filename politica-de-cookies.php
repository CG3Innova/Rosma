...
<head>
<meta charset="utf-8">
<title>Rosma Belleza - Politica de cookies</title>
                ...
                <div class="content-side pull-right col-md-12 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="lower-content">
                            ...
                            <ul>
                                <li><a href="https://windows.microsoft.com/es-es/windows-vista/Block-or-allow-cookies" target="_blank">Microsoft Internet Explorer o Microsoft Edge</a></li>
                                ...
                                <li><a href="https://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-las-cookies/" target="_blank">Safari</a></li>
                                <li><a href="https://help.opera.com/Linux/10.60/es-ES/cookies.html" target="_blank">Opera</a></li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.youronlinechoices.com/es/" target="_blank">Your Online Choices</a></li>
                            </ul>

                            <h2>Cookies utilizadas en www.rosmabelleza.com</h2>
                            <p>A continuación se identifican las cookies que están siendo utilizadas en este portal así como su tipología y función:</p>
                            <!-- Lista de cookies y su función -->

                            <h2>Aceptación de la Política de cookies</h2>
                            <p>www.rosmabelleza.com, asume que usted acepta el uso de cookies. No obstante, muestra información sobre su Política de cookies en la parte inferior o superior de cualquier página del portal con cada inicio de sesión con el objeto de que usted sea consciente.</p>
                            ...
                            <ul>
                                ...
                                <li><strong>Modificar su configuración:</strong> Podrá obtener más información sobre qué son las cookies, conocer la Política de cookies de: <a href="https://www.rosmabelleza.com" target="_blank">www.rosmabelleza.com</a> y modificar la configuración de su navegador.</li>
                            </ul>
                        </div>
