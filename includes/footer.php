                ...
                <div class="row clearfix">
                    ...
                    <div class="footer-column col-md-4 col-sm-12 col-xs-12">
                        <div class="footer-widget about-widget">
                            <div class="footer-logo">
                                <figure>
                                    <a href="index.html"><img src="images/logo-footer.png" alt="Logo Rosma Belleza"></a>
                                </figure>
                            </div>
                    ...
                    <div class="footer-column col-md-4 col-sm-12 col-xs-12">
                        <div class="footer-widget links-widget">
                            ...
                            <div class="widget-content">
                                <ul class="list">
                                    <li><a href="service-detail.html">Aviso legal</a></li>
                                    <li><a href="service-detail.html">Política de cookies</a></li>
                                    <li><a href="service-detail.html">Política de privacidad</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>   
         ...
         <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright-text clearfix">
                    <p>Copyright © <a href="index.html">Rosma Belleza</a> 2024.</p>
