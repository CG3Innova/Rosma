            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-md-9 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="image-box">
                            <figure><img src="../../images/servicios/con-buena-cara/pieles-sensibles.webp" alt="Pieles Sensibles - Rosma Belleza"></figure>
                        </div> 
                        <div class="lower-content">
                            <h2>Tratamiento para pieles sensibles</h2>
                            <p>Las pieles sensibles requieren un <strong>cuidado especial</strong> debido a su <strong>naturaleza reactiva</strong>, que responden intensamente a factores tanto internos como externos, así como a las emociones. Entendemos las necesidades de este tipo de pieles y por eso ofrecemos un <strong>tratamiento integral</strong> diseñado especialmente para devolverles su <strong>equilibrio y bienestar</strong>.</p>
                            <p>Nuestro tratamiento no solo restaura la dermis sino que también proporciona una profunda sensación de <strong>confort y suavidad</strong> y además actúa como una barrera protectora contra agresiones externas. Con un <strong>diagnóstico personalizado</strong> minimizamos reacciones alérgicas y fortalecemos el sistema inmune de la piel gracias a la cosmética <strong>SkinIdent</strong>.</p>
                        </div>
