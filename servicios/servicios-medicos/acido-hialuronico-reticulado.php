...
<div class="page-wrapper">
    ...
    <?php 
        ...
        $service = "acido-hialuronico-reticulado";
        $sidebar = "medicos";
    ...
    <section class="page-title">
        ...
        <div class="auto-container">
        	<div class="inner-container clearfix">
	            <h1>Ácido hialurónico reticulado</h1>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-md-9 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="image-box">
                            <figure><img src="../../images/servicios/acido-hialuronico-reticulado.jpg" alt="Ácido hialurónico reticulado - Rosma Belleza"></figure>
                        </div> 
