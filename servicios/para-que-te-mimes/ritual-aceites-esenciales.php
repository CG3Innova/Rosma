...
<head>
<meta charset="utf-8">
    <title>Masaje con aceites esenciales en Vitoria | Rosma Belleza</title>
    <meta name="title" content="Masaje con aceites esenciales en Vitoria | Rosma Belleza">
    <meta name="description" content="Disfruta de un ritual antiestrés en Rosma Belleza, Vitoria-Gasteiz. Masaje con aceites esenciales que nutre tu piel y equilibra cuerpo y mente.">
...
<div class="page-wrapper">
    ...
    <?php 
        $page = "servicios-2";
        $service = "ritual-aceites-esenciales";
    ...
    <section class="page-title">
        ...
        <div class="auto-container">
        	<div class="inner-container clearfix">
	            <h1>Ritual aceites esenciales</h1>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-md-9 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="image-box">
                            <figure><img src="../../images/servicios/para-que-te-mimes/ritual-aceites-esenciales.webp" alt="Ritual aceites esenciales - Rosma Belleza"></figure>
                        </div> 
