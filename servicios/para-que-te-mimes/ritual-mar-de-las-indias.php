...
<head>
<meta charset="utf-8">
    <title>Ritual Mar de las Indias en Vitoria | Rosma Belleza</title>
    <meta name="title" content="Ritual Mar de las Indias en Vitoria | Rosma Belleza">
    <meta name="description" content="Conecta cuerpo y mente con el Ritual Mar de las Indias en Rosma Belleza, Vitoria-Gasteiz. Exfoliación, baño lácteo y masaje con aceite tibio.">
...
<div class="page-wrapper">
    ...
    <?php 
        $page = "servicios-2";
        $service = "ritual-mar-de-las-indias";
    ...
    <section class="page-title">
        ...
        <div class="auto-container">
        	<div class="inner-container clearfix">
	            <h1>Ritual mar de las indias</h1>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-md-9 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="image-box">
                            <figure><img src="../../images/servicios/para-que-te-mimes/ritual-mar-de-las-indias.webp" alt="Ritual mar de las indias - Rosma Belleza"></figure>
                        </div> 
