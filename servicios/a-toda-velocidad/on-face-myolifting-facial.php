...
<div class="page-wrapper">
    ...
    <?php 
        $page = "servicios-2";
        $service = "on-face-myolifting-facial";
    ...
    <section class="page-title">
        ...
        <div class="auto-container">
        	<div class="inner-container clearfix">
	            <h1>On face myolifting facial</h1>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side pull-right col-md-9 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="image-box">
                            <figure><img src="../../images/servicios/a-toda-velocidad/on-face-myolifting-facial.webp" alt="On Face Myolifting Facial - Rosma Belleza"></figure>
                        </div> 
