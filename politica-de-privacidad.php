                ...
                <div class="content-side pull-right col-md-12 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="lower-content">
                            <h2>Rosma Belleza</h2>
                            <p>En aplicación de la normativa vigente en materia de protección de datos de carácter personal, informa que los datos personales que se recogen a través de los formularios del Sitio web: <a href="https://www.rosmabelleza.com">www.rosmabelleza.com</a>, se incluyen en los ficheros automatizados específicos de usuarios de los servicios de Amalia Muñoz Márquez con NIF:16256884R, en adelante Rosma Belleza.</p>
                            <p>La recogida y tratamiento automatizado de los datos de carácter personal tiene como finalidad el mantenimiento de la relación comercial y el desempeño de tareas de información, formación, asesoramiento y otras actividades propias de Rosma Belleza</p>
                            ...
                            <p>Rosma Belleza adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad de los datos conforme a lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de los mismos.</p>
                            <p>El usuario podrá en cualquier momento ejercitar los derechos de acceso, oposición, rectificación y cancelación reconocidos en el citado Reglamento (UE). El ejercicio de estos derechos puede realizarlo el propio usuario a través de email a: <a href="mailto:info@rosmabelleza.com">info@rosmabelleza.com</a> o en la dirección: C/ Madre Vedruna 12 bajo. 01008 Vitoria-Gasteiz.</p>
                            <p>El usuario manifiesta que todos los datos facilitados por él son ciertos y correctos, y se compromete a mantenerlos actualizados, comunicando los cambios a Rosma Belleza</p>

                            <h2>Finalidad del tratamiento de los datos personales:</h2>
                            <h3>¿Con qué finalidad trataremos tus datos personales?</h3>
                            <p>En Rosma Belleza, trataremos tus datos personales recabados a través del Sitio Web: <a href="https://www.rosmabelleza.com">www.rosmabelleza.com</a>, con las siguientes finalidades:</p>
                            <ul>
                            ...
                            <ul>
                                <li>La solicitud de información y/o la contratación de los servicios de Rosma Belleza, cuyos términos y condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.</li>
                            ...
                            <h2>Destinatarios:</h2>
                            <p>Los datos no se comunicarán a ningún tercero ajeno a Rosma Belleza, salvo obligación legal.</p>

                            <h2>Datos recopilados por usuarios de los servicios</h2>
                            <p>En los casos en que el usuario incluya ficheros con datos de carácter personal en los servidores de alojamiento compartido, Rosma Belleza no se hace responsable del incumplimiento por parte del usuario del RGPD.</p>

                            <h2>Retención de datos en conformidad a la LSSI</h2>
                            <p>Rosma Belleza informa de que, como prestador de servicio de alojamiento de datos y en virtud de lo establecido en la Ley 34/2002 de 11 de julio de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI), retiene por un periodo máximo de 12 meses la información imprescindible para identificar el origen de los datos alojados y el momento en que se inició la prestación del servicio. La retención de estos datos no afecta al secreto de las comunicaciones y sólo podrán ser utilizados en el marco de una investigación criminal o para la salvaguardia de la seguridad pública, poniéndose a disposición de los jueces y/o tribunales o del Ministerio que así los requiera.</p>
                            ...
                            <p>El usuario debe respetar los programas de terceros puestos a su disposición por Rosma Belleza, aun siendo gratuitos y/o de disposición pública.</p>
                            <p>Rosma Belleza dispone de los derechos de explotación y propiedad intelectual necesarios del software.</p>
                            ...
                            <p>Para toda actuación que exceda del cumplimiento del contrato, el usuario necesitará autorización por escrito por parte de Rosma Belleza, quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y ficheros de los servidores propiedad de Rosma Belleza, asumiendo la responsabilidad civil y penal derivada de cualquier incidencia que se pudiera producir en los servidores y sistemas de seguridad como consecuencia directa de una actuación negligente o maliciosa por su parte.</p>

                            <h3>Propiedad intelectual de los contenidos alojados</h3>
                            <p>Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por Rosma Belleza y, en particular de:</p>
                            <ul>
                                <li>La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.</li>
                                <li>La publicación o la transmisión de cualquier contenido que, a juicio de Rosma Belleza, resulte violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio.</li>
                            ...
                            <p>El usuario indemnizará a Rosma Belleza por los gastos que generara la imputación de Rosma Belleza en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de defensa jurídica, incluso en el caso de una decisión judicial no definitiva.</p>

                            <h2>Protección de la información alojada</h2>
                            <p>Rosma Belleza realiza copias de seguridad de los contenidos alojados en sus servidores, sin embargo no se responsabiliza de la pérdida o el borrado accidental de los datos por parte de los usuarios. De igual manera, no garantiza la reposición total de los datos borrados por los usuarios, ya que los citados datos podrían haber sido suprimidos y/o modificados durante el periodo del tiempo transcurrido desde la última copia de seguridad.</p>
                            <p>Los servicios ofertados, excepto los servicios específicos de backup, no incluyen la reposición de los contenidos conservados en las copias de seguridad realizadas por Rosma Belleza, cuando esta pérdida sea imputable al usuario; en este caso, se determinará una tarifa acorde a la complejidad y volumen de la recuperación, siempre previa aceptación del usuario.</p>
                            <p>La reposición de datos borrados sólo está incluida en el precio del servicio cuando la pérdida del contenido sea debida a causas atribuibles a Rosma Belleza</p>

                            <h2>Comunicaciones comerciales</h2>
                            <p>En aplicación de la LSSI. Rosma Belleza no enviará comunicaciones publicitarias o promocionales por correo electrónico u otro medio de comunicación electrónica equivalente que previamente no hubieran sido solicitadas o expresamente autorizadas por los destinatarios de las mismas.</p>
                            <p>En el caso de usuarios con los que exista una relación contractual previa, Rosma Belleza sí está autorizado al envío de comunicaciones comerciales referentes a productos o servicios de Rosma Belleza que sean similares a los que inicialmente fueron objeto de contratación con el cliente.</p>
