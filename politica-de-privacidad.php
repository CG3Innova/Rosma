...
<head>
<meta charset="utf-8">
    <title>Rosma Belleza | Política de privacidad</title>
    <meta name="title" content="Rosma Belleza | Política de privacidad">
                ...
                <div class="content-side pull-right col-md-12 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        <div class="lower-content">
                            <h2>Belleza y estética Rosa-Amalia, S.L.</h2>
                            <p>En aplicación de la normativa vigente en materia de protección de datos de carácter personal, informa que los datos personales que se recogen a través de los formularios del Sitio web: <a href="https://www.rosmabelleza.com">www.rosmabelleza.com</a>, se incluyen en los ficheros automatizados específicos de usuarios de los servicios de Belleza y estética Rosa-Amalia, S.L.</p>
                            <p>La recogida y tratamiento automatizado de los datos de carácter personal tiene como finalidad el mantenimiento de la relación comercial y el desempeño de tareas de información, formación, asesoramiento y otras actividades propias de Belleza y estética Rosa-Amalia, S.L.</p>
                            ...
                            <p>Belleza y estética Rosa-Amalia, S.L. adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad de los datos conforme a lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de los mismos.</p>
                            <p>El usuario podrá en cualquier momento ejercitar los derechos de acceso, oposición, rectificación y cancelación reconocidos en el citado Reglamento (UE). El ejercicio de estos derechos puede realizarlo el propio usuario a través de email a: <a href="mailto:rosma@rosmabelleza.com">rosma@rosmabelleza.com</a> o en la dirección: Av. Gasteiz, 21, 1ºizq (Vitoria, Álava)</p>
                            <p>El usuario manifiesta que todos los datos facilitados por él son ciertos y correctos, y se compromete a mantenerlos actualizados, comunicando los cambios a Belleza y estética Rosa-Amalia, S.L.</p>

                            <h2>Finalidad del tratamiento de los datos personales:</h2>
                            <h3>¿Con qué finalidad trataremos tus datos personales?</h3>
                            <p>En Belleza y estética Rosa-Amalia, S.L., trataremos tus datos personales recabados a través del Sitio Web: <a href="https://www.rosmabelleza.com">www.rosmabelleza.com</a>, con las siguientes finalidades:</p>
                            <ul>
                                <li>En caso de contratación de los bienes y servicios ofertados a través de www.rosmabelleza.com, para mantener la relación contractual, así como la gestión, administración, información, prestación y mejora del servicio.</li>
                                <li>Envío de información solicitada a través de los formularios dispuestos en www.rosmabelleza.com</li>
                                <li>Remitir boletines (newsletters), así como comunicaciones comerciales de promociones y/o publicidad de www.rosmabelleza.com y del sector.</li>
                            </ul>
                            ...
                            <ul>
                                <li>La solicitud de información y/o la contratación de los servicios de Belleza y estética Rosa-Amalia, S.L., cuyos términos y condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.</li>
                            ...
                            <h2>Destinatarios:</h2>
                            <p>Los datos no se comunicarán a ningún tercero ajeno a Belleza y estética Rosa-Amalia, S.L, salvo obligación legal.</p>

                            <h2>Datos recopilados por usuarios de los servicios</h2>
                            <p>En los casos en que el usuario incluya ficheros con datos de carácter personal en los servidores de alojamiento compartido, Belleza y estética Rosa-Amalia, S.L. no se hace responsable del incumplimiento por parte del usuario del RGPD.</p>

                            <h2>Retención de datos en conformidad a la LSSI</h2>
                            <p>Belleza y estética Rosa-Amalia, S.L. informa de que, como prestador de servicio de alojamiento de datos y en virtud de lo establecido en la Ley 34/2002 de 11 de julio de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI), retiene por un periodo máximo de 12 meses la información imprescindible para identificar el origen de los datos alojados y el momento en que se inició la prestación del servicio. La retención de estos datos no afecta al secreto de las comunicaciones y sólo podrán ser utilizados en el marco de una investigación criminal o para la salvaguardia de la seguridad pública, poniéndose a disposición de los jueces y/o tribunales o del Ministerio que así los requiera.</p>
                            ...
                            <p>Belleza y estética Rosa-Amalia, S.L es titular de todos los derechos de autor, propiedad intelectual, industrial, “know how” y cuantos otros derechos guardan relación con los contenidos del sitio web <a href="https://www.rosmabelleza.com">www.rosmabelleza.com</a> y los servicios ofertados en el mismo, así como de los programas necesarios para su implementación y la información relacionada.</p>
                            <p>No se permite la reproducción, publicación y/o uso no estrictamente privado de los contenidos, totales o parciales, del sitio web www.rosmabelleza.com sin el consentimiento previo y por escrito.</p>

                            <h3>Propiedad intelectual del software</h3>
                            <p>El usuario debe respetar los programas de terceros puestos a su disposición por Belleza y estética Rosa-Amalia, S.L, aun siendo gratuitos y/o de disposición pública.</p>
                            <p>Belleza y estética Rosa-Amalia, S.L. dispone de los derechos de explotación y propiedad intelectual necesarios del software.</p>
                            ...
                            <p>Para toda actuación que exceda del cumplimiento del contrato, el usuario necesitará autorización por escrito por parte de Belleza y estética Rosa-Amalia, S.L, quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y ficheros de los servidores propiedad de Belleza y estética Rosa-Amalia, S.L, asumiendo la responsabilidad civil y penal derivada de cualquier incidencia que se pudiera producir en los servidores y sistemas de seguridad como consecuencia directa de una actuación negligente o maliciosa por su parte.</p>

                            <h3>Propiedad intelectual de los contenidos alojados</h3>
                            <p>Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por Belleza y estética Rosa-Amalia, S.L y, en particular de:</p>
                            <ul>
                                <li>La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.</li>
                                <li>La publicación o la transmisión de cualquier contenido que, a juicio de Belleza y estética Rosa-Amalia, S.L, resulte violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio.</li>
                            ...
                            <p>El usuario indemnizará a Belleza y estética Rosa-Amalia, S.L por los gastos que generara la imputación de Belleza y estética Rosa-Amalia, S.L en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de defensa jurídica, incluso en el caso de una decisión judicial no definitiva.</p>

                            <h2>Protección de la información alojada</h2>
                            <p>Belleza y estética Rosa-Amalia, S.L realiza copias de seguridad de los contenidos alojados en sus servidores, sin embargo no se responsabiliza de la pérdida o el borrado accidental de los datos por parte de los usuarios. De igual manera, no garantiza la reposición total de los datos borrados por los usuarios, ya que los citados datos podrían haber sido suprimidos y/o modificados durante el periodo del tiempo transcurrido desde la última copia de seguridad.</p>
                            <p>Los servicios ofertados, excepto los servicios específicos de backup, no incluyen la reposición de los contenidos conservados en las copias de seguridad realizadas por Belleza y estética Rosa-Amalia, S.L, cuando esta pérdida sea imputable al usuario; en este caso, se determinará una tarifa acorde a la complejidad y volumen de la recuperación, siempre previa aceptación del usuario.</p>
                            <p>La reposición de datos borrados sólo está incluida en el precio del servicio cuando la pérdida del contenido sea debida a causas atribuibles a Belleza y estética Rosa-Amalia, S.L</p>

                            <h2>Comunicaciones comerciales</h2>
                            <p>En aplicación de la LSSI. Belleza y estética Rosa-Amalia, S.L no enviará comunicaciones publicitarias o promocionales por correo electrónico u otro medio de comunicación electrónica equivalente que previamente no hubieran sido solicitadas o expresamente autorizadas por los destinatarios de las mismas.</p>
                            <p>En el caso de usuarios con los que exista una relación contractual previa, Belleza y estética Rosa-Amalia, S.L sí está autorizado al envío de comunicaciones comerciales referentes a productos o servicios de Belleza y estética Rosa-Amalia, S.L que sean similares a los que inicialmente fueron objeto de contratación con el cliente.</p>
